...
const Activities = () => {
    ...
    const fetchBanners = async () => {
      try {
        const [desktopResponse, mobileResponse] = await Promise.all([
          axios.get("https://51.20.119.151/api/desktop-banners/"),
          axios.get("https://51.20.119.151/api/mobile-banners/"),
        ]);
  ...
  const fetchCourses = async (category) => {
    ...
    try {
      const response = await axios.get(
        "https://51.20.119.151/api/courses/by-course-type",
        {
          ...
          if (course.providerId) {
            try {
              const providerResponse = await axios.get(
                `https://51.20.119.151/api/users/provider/${course.providerId}`
              );
              console.log(
  ...
  //     try {
  //         const response = await axios.get('https://51.20.119.151/api/advertisement');
                        ...
                        <div className="activity-buttons">
                          <button
                            ...
                            onClick={async () => {
                              try {
                                await fetch(
                                  "https://51.20.119.151/api/leads/track",
                                  {
                                    method: "POST",
                                    headers: {
