...
const Activities = () => {
    ...
    const fetchBanners = async () => {
      try {
        const [desktopResponse, mobileResponse] = await Promise.all([
          axios.get("https://https://16.171.204.252.252/api/desktop-banners/"),
          axios.get("https://https://16.171.204.252.252/api/mobile-banners/"),
        ]);
  ...
  const fetchCourses = async (category) => {
    ...
    try {
      const response = await axios.get(
        "https://https://16.171.204.252.252/api/courses/by-course-type",
        {
          ...
          if (course.providerId) {
            try {
              const providerResponse = await axios.get(
                `https://https://16.171.204.252.252/api/users/provider/${course.providerId}`
              );
              console.log(
  ...
  //     try {
  //         const response = await axios.get('https://https://16.171.204.252.252/api/advertisement');
                        ...
                        <div className="activity-buttons">
                          <button
                            ...
                            onClick={async () => {
                              try {
                                await fetch(
                                  "https://https://16.171.204.252.252/api/leads/track",
                                  {
                                    method: "POST",
                                    headers: {
