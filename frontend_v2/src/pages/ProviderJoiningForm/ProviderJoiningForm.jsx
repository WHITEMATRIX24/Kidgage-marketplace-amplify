...
function ProviderJoiningForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      formData.academyBio === "" ||
      formData.academyEmail === "" ||
      formData.academyPhoneNo === "" ||
      formData.academyAddress === "" ||
      formData.academyLocation === "" ||
      formData.academyCRNo === "" ||
      formData.academyFile === "" ||
      formData.fullName === "" ||
  ...
  return (
    <div className="d-flex align-items-center justify-content-center mt-5">
      <div className="ProviderJoingFormContainer p-2  p-md-5">
        <h2 className="ProviderJoiningTitle px-3">
          Join our provider list, it's free
        </h2>
        <p className="ProviderJoiningText px-3">
          Please note that currently we are onboarding companies registered in
          Qatar
        </p>
        <div className="row mt-1 mt-lg-5">
          <div className="col-lg-6">
            <div className="input-container">
              <label className="providerJoiningLabel" htmlFor="academyName">
                Academy Name
              </label>
              <input
            ...
            <div className="input-container">
              ...
              />
              <label
                className="providerJoiningTextAreaLabel"
                htmlFor="academyBio"
              >
                Academy Bio
              </label>
            ...
            <div className="row">
              <div className="col-md-5 pEnd pe-0">
                <div className="input-container">
                  <label
                    className="providerJoiningLabel"
                    htmlFor="academyPhoneNo"
                  >
                    Phone number
                  </label>
                  <input
          ...
          <div className="col-lg-6">
            <div className="input-container">
              <label
                className="providerJoiningLabelLocation"
                htmlFor="academyLocation"
              >
                Location
              </label>
            ...
            <div className="row ">
              <div className="col-md-5 pe-0 pEnd">
                <div className="input-container">
                  <label className="providerJoiningLabel" htmlFor="academyCRNo">
                    CR Number
                  </label>
                  <input
                    className="providerJoiningInput"
              ...
              <div className="col-md-7 ps-0 pStart ">
                <div className="input-container">
                  <label
                    className="providerJoiningFileLabel"
                    htmlFor="academyFile"
                  >
                    CR Doc[pdf format]
                  </label>
            ...
            <div className="row">
              <div className="col-md-7 pe-0 pEnd">
                <div className="input-container">
                  <label className="providerJoiningLabel" htmlFor="fullName">
                    Full Name
                  </label>
                  <input
                    className="providerJoiningInput"
              ...
              <div className="col-md-5 ps-0 pStart ">
                <div className="input-container ">
                  <label className="providerJoiningLabel" htmlFor="designation">
                    Designation
                  </label>
                  <input
                    className="providerJoiningInput"
            ...
            <div className="row w-100 buttonDiv d-flex align-items-center justify-content-center">
                ...
                <div className="checkbox-container  d-flex align-items-center justify-content-center flex-column">
                  <div className="d-flex align-items-center justify-content-center">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <label className="ms-2 termsText" htmlFor="terms">
                      I agree that all provided information is correct for
              ...
              <div className="col-md-5 px-0 d-flex " style={{ height: "60px" }}>
                <button onClick={handleSubmit} className="continueButton mb-1">
                  Continue
                </button>
              </div>
            </div>
