          ...
          <div className="navbar ">
            <div className="row w-100 m-3">
              <div className="col-3 col-lg-2  pe-md-0  ">
                <img
                  className="academyLogo ms-xx-5 "
                  src={provider?.logo || logo}
                  alt=""
                />
              </div>
              <div className="col-9 col-lg-10 navText">
                ...
                <div className="row d-flex w-100">
                  ...
                  <div className="socialMediaIcon col-lg-6">
                    <div className="text-end">
                      <a
                  ...
                  <div className="row mt-2" key={index}>
                    <div className="col-2">
                      <div className="blackImage">
                        <FontAwesomeIcon
                          className="highlightIcon text-light"
                          icon={faFacebook}
                          size="12px"
                        />
                      </div>
          ...
          {downArrow && (
            <div className="row w-100 d-flex align-items-center justify-content-center mt-3 ">
              <button
                ...
                className="btn d-flex align-items-center justify-content-center academyDownArrowButton"
              >
