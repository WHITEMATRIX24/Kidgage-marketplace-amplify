                ...
                <div className="row">
                    ...
                    <div key={item.bookingId} className="booking-box">
                            <div className="booking-content">
                                <p className="booking-top-content">{item.bookingDate} Booking ID: #{item.bookingId}</p>
                                <div className="booking-button-content">
                                    <div className="booking-text-content">
                                        <h3 >
                                            Event <span className="booking-text-span">{item.courseName}</span>
                                        </h3>
                                        {item.status ?<div> <p>Status: <span className="booking-status-text">Booking Successfull</span> </p></div>:
                                        <div> <p>Status: <span className="booking-status-text text-warning">Pending</span> </p></div>
                                        }
                                    </div>
                                    <div className="booking-button ">
                                        <button onClick={()=>generatePDF(item)} className="booking-button-btn">
                                            Download
                                        </button>
                                    </div>
                                </div>
